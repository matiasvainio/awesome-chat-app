...
mongoose.connect('mongodb+srv://sudo:sudo123@chatapp.7etcu.mongodb.net/chatapp?retryWrites=true&w=majority', { promiseLibrary: require('bluebird') }, options)
...
app.post('/submit', (req, res) => {
  ...
  messages.findOne(function(error, result) { sender: Joni });
});
...
app.post('/signup', async (req, res) => {
  ...
  const users = collection.find({username: currentUser}).toArray()
  .then(results => {
    console.log(results)
  })
